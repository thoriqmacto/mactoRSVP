...
class MactoRSVP_Admin extends MactoRSVP_Abstract {
	 ...
	 * @var string
	 */
	protected $options_key = 'mactoRSVP';
	...
	public static function default_options() {
		return MactoRSVP::default_options();
	}
	...
	public function admin_menu() {
		add_menu_page(
			__( 'RSVP Your Event', 'macto-rsvp' ),	// page_title
			__( 'RSVP', 'macto-rsvp' ),				// menu_title
			'manage_options',						// capability
			'mactoRSVP',							// slug
			array( 'MactoRSVP', 'settings_page' ),	// function
			'',										// icon
			'80.1'									// position
		);
	...
	public function admin_init() {
		// register_setting( 'mactoRSVP', 'mactoRSVP',  array( &$this, 'save_settings' ) );
